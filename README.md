...
3. **CRITICAL:** Delete `C:\Windows\System32\drivers\PxHlpa64.sys` (Roxio driver installed by DVE). If you skip this step, your machine will BSOD and fail to boot after reboot.
